...
<tr><th scope="row"><?php esc_html_e(
    ...
    public static function translate_petitioner_labels(array $labels): array
    {
        return array_merge($labels, [
            ...
            "captcha_verification_failed_title" => __("Vérification anti-robot impossible.", "plaidact-campaign-core"),
            "captcha_invalid_type" => __("Le système anti-robot est mal configuré.", "plaidact-campaign-core"),
            "captcha_missing_response" => __("Veuillez terminer la vérification anti-robot.", "plaidact-campaign-core"),
            "captcha_connection_failed" => __("Le service anti-robot est temporairement indisponible. Réessayez.", "plaidact-campaign-core"),
            "captcha_verification_failed" => __("La vérification anti-robot a échoué. Réessayez.", "plaidact-campaign-core"),
            "captcha_score_too_low" => __("La vérification anti-robot a refusé la demande. Réessayez.", "plaidact-campaign-core"),
            "captcha_verification_completed" => __("Vérification anti-robot terminée.", "plaidact-campaign-core"),
