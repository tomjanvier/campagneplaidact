...
- Shortcodes : `[petition_form]`, `[plaid_newsletter_form]`, `[plaid_partners]`, `[plaidact_breves]`, `[plaidact_asso_directory]`, `[plaidact_contact_directory]`, `[plaid_send_campaign]`, `[plaid_social_wall]`. `[plaid_breves]` et `[breves]` restent acceptés comme alias. Le shortcode des brèves accepte `title`, `description`, `limit` et `topic`. Le formulaire newsletter rendu par `[plaid_newsletter_form]` porte aussi la classe `stp-newsletter-form` et soumet les inscriptions au flux Brevo configuré dans **Réglages → PLAID·ACT**.
